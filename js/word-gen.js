...
function buildChapter1(docx,data){
  ...
  var jeogamTable=new Table2({
    ...
    rows:[
      ...
      new TableRow2({height:{value:ROW},children:[cell2(p2("T-P",true),{wPct:21}),cell2(p2(""),{wPct:23,borders:cb2({right:non2})}),cell2(p2("mg/L"),{wPct:15,borders:cb2({left:non2})})]}),
      new TableRow2({height:{value:ROW},children:[cell2(p2("비점오염\n저감계획",true),{rs:3,wPct:12}),cell2(p2("종류",true),{wPct:15}),cell2(p2("적용면적",true),{wPct:15}),cell2(p2("처리용량",true),{wPct:15}),cell2(p2("삭감량(kg/일)",true),{cs:2,wPct:28})]}),
      new TableRow2({height:{value:ROW},children:[cell2(p2(""),{wPct:15}),cell2(p2(""),{wPct:15}),cell2(p2(""),{wPct:15}),cell2(p2("BOD",true),{wPct:14}),cell2(p2("T-P",true),{wPct:14})]}),
      new TableRow2({height:{value:ROW},children:[cell2(p2(""),{wPct:15}),cell2(p2("-",true),{wPct:15}),cell2(p2("-",true),{wPct:15}),cell2(p2("-",true),{wPct:14}),cell2(p2("-",true),{wPct:14})]})
    ]
  });
